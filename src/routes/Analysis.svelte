...
<main>
  ...
  <section class="pt-32">
    ...
    <div class="flex flex-col">
      <Card class="flex">
        <p class="text-center">
          We want to test if there is a significant difference in the average price per sqm in highly urbanized cities 
          vs non-highly urbanized cities for different real estate types. Since we are dealing with a categorical variable 
          (highly urbanized or not) and continuous variable (price per square meter), we can use either the independent t-test 
          or the Mann-Whitney U test depending on the normality of our data.
        </p>
      </Card>
      ...
      <div class="grid grid-rows-3 grid-flow-col gap-4">
        <Card>
          <div class="text-center">
            ...
            <p>Since our histogram fails to show a bell curve, we cannot assume normality of data. 
              Hence we use the <b>Mann-Whitney U test</b> to obtain a p-value.
            </p>
            <p>With a significance level of 0.05 and a p-value of 1.5365x10<sup>-29</sup>, 
              <b>we reject our null hypothesis</b>. Therefore, the price per sqm for houses 
              in highly-urbanized areas are <b>significantly different</b> from less urbanized areas.
            </p>
          </div>
        </Card>
        <Card>
